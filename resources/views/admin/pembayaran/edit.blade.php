                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="jenis_pembayaran">Jenis Pembayaran <span class="text-danger">*</span></label> <select class="form-control @error('jenis_pembayaran') is-invalid @enderror"
                                            ...
                                            <option value="spp_bulanan" {{ old('jenis_pembayaran', $pembayaran->jenis_pembayaran) == 'spp_bulanan' ? 'selected' : '' }}>SPP Bulanan</option>
                                            <option value="seragam" {{ old('jenis_pembayaran', $pembayaran->jenis_pembayaran) == 'seragam' ? 'selected' : '' }}>Seragam</option>
                                            <option value="ujian" {{ old('jenis_pembayaran', $pembayaran->jenis_pembayaran) == 'ujian' ? 'selected' : '' }}>Buku & Alat Tulis</option>
                                            <option value="kitab" {{ old('jenis_pembayaran', $pembayaran->jenis_pembayaran) == 'kitab' ? 'selected' : '' }}>Kitab-kitab Pelajaran</option>
